...
Verified by local Apple developer tooling on 2026-07-17. Public artifacts must not contain serial numbers, UDIDs, signing identities, or other device identifiers.

| Device | OS | Verified state | Intended role |
|---|---|---|---|
| iPhone 15 Pro | iOS 26.2.1 | Physical, paired, developer mode enabled, currently unavailable; prior QVAC evidence identifies this device | Higher-capability Apple baseline; potential Apple Foundation Models follow-up if eligible and enabled |
...
1. Physically connect and unlock each intended Apple device, then rerun the inventory.
